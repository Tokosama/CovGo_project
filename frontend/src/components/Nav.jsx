...
const Nav = memo(({ activeMenu = 'home' }) => {
  ...
  return (
    <div className="fixed bottom-[-1px] z-100 left-0 w-full bg-[#ADE8F4] border-t border-gray-300 flex justify-between items-center px-1 py-2" style={{boxShadow: '0px -2px 8px #0001'}}>
      <NavItem 
        icon={faHome} 
        label="Home" 
        isActive={isHome} 
