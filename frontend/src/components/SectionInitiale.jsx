...
export default function SectionInitiale({
  ...
  return (
    ...
    >
      <div className="w-[70%] text-center items-center justify-center mx-auto text-[21px] font-bold text-black mb-12">Vérifiez vos Informations avant de publier des trajets</div>
      {/* Bloc permis */}
      <div className="w-full max-w-[300px] mx-auto flex flex-col gap-2 mb-2">
        <span className="font-bold text-[21px] text-black">Rajouter votre Permis de conduire</span>
      ...
      <div className="w-full max-w-[300px] mx-auto flex flex-col gap-2 mb-2 mt-2">
        <span className="font-bold text-[21px] text-black">Rajouter une photo de vous avec le permis de conduire</span>
