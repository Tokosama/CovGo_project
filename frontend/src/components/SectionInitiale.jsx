...
export default function SectionInitiale({
  ...
  return (
    ...
    >
      <div className="w-[90%] text-center items-center justify-center mx-auto text-[21px] font-bold text-[#FF1D1D] mb-12">Vérifiez vos Informations avant de publier des trajets
      <hr className="w-full border-t border-gray-400 mt-7" />
      </div>
      {/* Bloc permis */}
      <div className="w-full max-w-[320px] mx-auto flex flex-col gap-2 mb-2">
        <span className="font-bold text-[19px] text-center text-black">Rajouter votre Permis de conduire</span>
      ...
      <div className="w-full max-w-[300px] mx-auto flex flex-col gap-2 mb-2 mt-2">
        <span className="font-bold text-[19px] text-center text-black">Rajouter une photo de vous avec le permis de conduire</span>
      ...
      <hr className="w-[90%] mx-auto mt-2 mb-2 border-gray-300" />
    </motion.div>
  );
} 