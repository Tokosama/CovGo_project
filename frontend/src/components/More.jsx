  ...
  return (
    <div className="min-h-screen h-screen bg-white flex flex-col items-center font-itim w-full pb-10 relative overflow-y-auto">
      ...
      <div className="flex flex-col items-center mb-2">
        <div className="mt-8 mb-2 bg-[#3B82F6] rounded-full w-[95px] h-[90px] flex items-center justify-center shadow-custom">
      ...
      <div className="w-full max-w-[388px] px-2">
        ...
        <div className="bg-[#3B82F6] text-white rounded-lg px-3 py-3 mb-2 shadow-custom">
          <span className=" text-[22px] ">CovGo est une plateforme de Covoiturage. Mettant en Relation des conducteurs et des passagers,</span>
      ...
      <div className="w-full max-w-[388px] px-2 mt-6">
        ...
        <div className="bg-[#3B82F6] text-white shadow-custom rounded-lg px-3 py-3 mb-2">
          <span className=" text-[22px]">Une équipe passionnée par la mobilité partagée,</span>
      ...
      <div className="w-full max-w-[388px] px-2 mt-6">
        ...
        <div className="bg-[#3B82F6] text-white shadow-custom rounded-lg px-3 py-3 mb-2">
          <span className=" text-[22px]">La sécurité de nos utilisateurs est notre priorité,</span>
      ...
      <div className="w-full max-w-[388px] px-2 mt-6">
        <h2 className="text-[36px] font-bold text-gray-700 mb-2">Pourquoi nous choisir ?</h2>
          <div className="bg-[#3B82F6] text-white shadow-custom rounded-lg px-3 py-3 mb-2">
          <span className=" text-[24px]">Un service simple, économique et humain,</span>
