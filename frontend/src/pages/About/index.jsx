    ...
    <div className="fixed text-black inset-0 z-50 flex items-start justify-center bg-white backdrop-blur-[2px]">
      ...
      >
        ...
        <div className="flex flex-col gap-2 w-full max-w-[260px] mb-8">
          <button className="bg-#00000040 text-[#00000080] text-[16px] font-bold rounded-md py-2 shadow-md">C'est quoi CovGo</button>
          <button className="bg-#00000040 text-[#00000080] text-[16px] font-bold rounded-md py-2 shadow-md">Qui Sommes nous</button>
          <button className="bg-#00000040 text-[#00000080] text-[16px] font-bold rounded-md py-2 shadow-md">Votre securitee</button>
          <button className="bg-#00000040 text-[#00000080] text-[16px] font-bold rounded-md py-2 shadow-md">Pourquoi nous choisir</button>
        </div>
        {/* Bouton inscription */}
        <button
          className="border border-black text-[13px] font-bold rounded-md py-2 px-4 w-full max-w-[220px]"
