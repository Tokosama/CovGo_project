    ...
    <div className="min-h-screen bg-white flex flex-col items-center font-itim">
      ...
      <form className="w-full max-w-[400px] flex flex-col items-center px-4 pt-4">
        ...
        <div className="flex w-full gap-2 mb-2">
          ...
          <div className="w-[60px] h-[60px] bg-[#EDEDED] rounded-xl flex items-center justify-center border border-[#D9D9D9] cursor-pointer relative" onClick={handleCameraClick}>
            {photo ? (
