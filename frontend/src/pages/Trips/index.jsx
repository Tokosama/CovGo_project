...
export default function Trips() {
  ...
  return (
    <div className="min-h-screen bg-white pb-24 font-itim w-full overflow-y-auto flex flex-col items-center">
      ...
      {tab === "historique" && (
        <div
          className="bg-[#ADE8F4] text-black border-2 border-[#000000] rounded-2xl shadow-md px-3 py-2 mx-4 mb-4 w-[90%] max-w-[600px]"
          style={{ minWidth: 0 }}
        >
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2">
          ...
          <div className="flex items-center justify-between mt-1">
            ...
            <span className="text-[13px] font-bold">
              Statut : <span className="text-[#D11B52]">Terminée</span>
            </span>
          </div>
        </div>
      )}
