  ...
  return (
    <div className="min-h-screen bg-white pb-24 font-itim w-full overflow-y-auto">
      ...
      <motion.button
        ...
        <h1 className="flex-1 text-center text-[20px] font-bold text-black">Mes Notifications</h1>
      </div>
      {/* Onglets */}
      <div className="flex gap-2 text-black mt-6 mb-0 px-20">
        <button
          className={`px-4 py-2 rounded-t-lg font-bold text-[16px] shadow ${tab === 'nonlu' ? 'bg-[#D9D9D9] border-b-2 border-black' : 'bg-transparent'}`}
          style={{ minWidth: 100 }}
        ...
        <button
          className={`px-4 py-2 rounded-t-lg font-bold text-[16px] ${tab === 'lu' ? 'bg-[#D9D9D9] border-b-2 border-black' : 'bg-transparent'}`}
          style={{ minWidth: 80 }}
          onClick={() => setTab('lu')}
        >
          Lu
      ...
      {tab === 'nonlu' ? (
        <div className="flex flex-col items-center w-full mt-2">
          <div className="bg-[#D9D9D9] text-black rounded-xl shadow px-4 py-2 w-[90%] max-w-[400px] text-center font-bold text-[15px] mb-4">Reservation Confirme</div>
          {/* Flèche verticale */}
          <div className="w-1 h-6 bg-transparent flex flex-col items-center justify-center mb-2">
            <span className="text-black text-lg">↓</span>
          </div>
          <div className="bg-[#D9D9D9] text-black rounded-xl shadow px-4 py-2 w-[90%] max-w-[400px] text-center font-bold text-[15px] mb-0">Reservation Confirme</div>
          <div className="bg-[#D9D9D9] text-black rounded-xl shadow px-4 py-2 w-[90%] max-w-[400px] text-center text-[14px] mt-1">
