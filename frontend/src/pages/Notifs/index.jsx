    ...
    <div className="min-h-screen bg-white pb-24 font-itim w-full overflow-y-auto flex flex-col items-center">
      ...
      {tab === 'nonlu' ? (
        <div className="flex flex-col items-center w-full mt-2">
          ...
          <div className="bg-[#D9D9D9] text-black rounded-xl shadow px-4 py-2 w-[95%] max-w-[600px] text-center font-bold text-[15px] mb-0">Reservation Confirme</div>
          <div className="bg-[#D9D9D9] text-black rounded-xl shadow px-4 py-2 w-[95%] max-w-[600px] text-center text-[14px] mt-1">
